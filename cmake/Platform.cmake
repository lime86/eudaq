...
if(${ROOT_FOUND})
  ...
  IF((ROOT_CXX_FLAGS MATCHES ".*std=c\\+\\+1[7z].*") OR (ROOT_CXX_FLAGS MATCHES ".*std:c\\+\\+1[7z].*"))
    IF(NOT SUPPORT_STD_CXX17)
      MESSAGE(FATAL_ERROR "ROOT was built with C++17 support but current compiler doesn't support it")
    ENDIF()
  ELSEIF((ROOT_CXX_FLAGS MATCHES ".*std=c\\+\\+1[14y].*") OR (ROOT_CXX_FLAGS MATCHES ".*std:c\\+\\+1[14y].*"))
    SET(CMAKE_CXX_STANDARD 14)
  ELSEIF((ROOT_CXX_FLAGS MATCHES ".*std=c\\+\\+.*") OR (ROOT_CXX_FLAGS MATCHES ".*std:c\\+\\+.*"))
