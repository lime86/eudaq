...
namespace eudaq {
  ...
  public:
    ...
    /** Get the instance of the plugin manager. As this is a singleton class
     * with
     *  private constructor and copy constructor, this is the only way to access
     * it.
     */
    ...
    static int IsSyncWithTLU(eudaq::Event const &ev,
                             eudaq::TLUEvent const &tlu);
    static t_eventid getEventId(eudaq::Event const &ev);

    static void setCurrentTLUEvent(eudaq::Event &ev,
                                   eudaq::TLUEvent const &tlu);
